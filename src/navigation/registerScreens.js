...
import { LOGIN_SCREEN, HOME_SCREEN, REGISTER_SCREEN, INITIAL_SCREEN, SEARCH_SCREEN, FRIEND_SCREEN } from './Screens';
...
export default function () {
  ...
  Navigation.registerComponent(FRIEND_SCREEN, () => WrappedComponent(FriendScreen));
